...
import os
from Task_2A import ShortestPathFinder, StationLineFinder  # Assuming these classes are defined in Task_2A
...
def analyze_performance(num_lines, num_stations_per_line, num_interchange_stations, line, directory):
    ...
    file_path = os.path.join(directory, 'synthetic_data_stations_count_dijkstras.xlsx')
    ...
    graph = Graph_count_stations(file_path)
