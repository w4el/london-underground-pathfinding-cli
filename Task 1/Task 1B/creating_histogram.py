...
file_path = os.path.join(parent_dir, r"Data sets\london_underground_shortest_paths_in_journey_duration.csv")
df = pd.read_csv(file_path)
# Extract the travel time data
travel_times = df['Travel Time (minutes)']
...
plt.title('Histogram of Travel Time (duration in minutes) before closure - dijkstras')
plt.xlabel('Travel Time (duration in minutes)')
